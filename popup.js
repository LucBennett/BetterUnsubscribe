...
function applyTheme(theme) {
    ...
    if (theme && theme.colors && theme.colors.popup_text) {
        ...
        document.documentElement.style.setProperty('--in-content-button-color', theme.colors.popup_text);// not sure about this
    } else {
    ...
    if(theme && theme.colors && theme.colors.sidebar_text) {
        document.documentElement.style.setProperty('--in-content-secondary-text-color', theme.colors.sidebar_text);
    }else{
    ...
    if (theme && theme.colors && theme.colors.toolbar_field_text) {
        document.documentElement.style.setProperty('--in-content-code-color', theme.colors.toolbar_field_text);
    } else {
